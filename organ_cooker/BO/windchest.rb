...
class WindChest
    ...
    def nb_notes=(nb_notes)
      ...
      raise ArgumentError, 'Number of notes must be positive' if nb_notes.zero? || nb_notes < 0
      @nb_notes = nb_notes
    end
    ...
    def foot_height=(height)
      ...
      raise ArgumentError, 'The height must be positive' if height.zero? || height < 0
      @foot_height = height
    end
